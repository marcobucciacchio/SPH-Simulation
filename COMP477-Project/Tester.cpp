...
Tester::Tester(const char* windowTitle, int argc, char** argv) {
	...
	Program = new ShaderProgram("Plane.glsl", ShaderProgram::eRender);
	InstanceProgram = new ShaderProgram("Sphere.glsl", ShaderProgram::eRender);
	Cam = new Camera;
	...
	//init SPH system
	sphSystem = new SPHSystem(20, 0.02f, 1000, 1, 1.04f, 0.15f, -9.8f, 0.2f, 4.0f);
}
...
void Tester::Draw() {
	...
	ImGui_ImplGLUT_NewFrame();
	{
		...
		ImGui::SliderInt("Number of Particles", &numParticles, 5, 30);            // Edit number of particles
		ImGui::SliderFloat("Box Width", &boxWidth, 0.01f, 5.f);            // Edit Box Size
		ImGui::SliderFloat("Mass of Particles", &nMass, 0.001f, 1.f);            // Edit mass9
		ImGui::SliderFloat("Support Radius", &nh, 0.01f, 0.3f);            // Edit support radius
		ImGui::SliderFloat("Rest Density", &nRest, 0.001f, 2000.f);            // Edit rest density
		ImGui::SliderFloat("Viscosity Constant", &nVisco, 0.01f, 5.f);            // Edit viscosity
		ImGui::SliderFloat("Gas Constant", &gasConst, 0.01f, 5.f);            // Edit gas constant
	

		if (ImGui::Button("RESET")) {
			delete sphSystem;
			sphSystem = new SPHSystem(numParticles, nMass, nRest, gasConst, nVisco, nh, -9.8, 1.f, boxWidth);
		}
